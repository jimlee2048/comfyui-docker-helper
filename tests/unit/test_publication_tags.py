...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"example/image:{'x' * 129}", "build.invalid_image_reference"),
        ("a" * 248, "build.invalid_image_reference"),
        (f"registry.example/{'a' * 256}", "build.invalid_image_reference"),

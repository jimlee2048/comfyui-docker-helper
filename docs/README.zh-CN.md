...
- [配置](user/configuration.zh-CN.md)——选择示例、组合配置层，并选择支持的应用、工具、节点和 Hook 输入。
- [构建与锁定](user/build-and-lock.zh-CN.md)——使用可用的协调模式验证、解析、渲染并构建镜像。
- [运行时](user/runtime.zh-CN.md)——配置和运行容器，管理下载、Hook、SSH 和关闭流程。
